...
const Features = () => {
  ...
  return (
         ...
         <Title title= 'Build your resume' description='Our streamlined process helps you to create a proffesional reume in minutes with intelligent AI-powered tools and features '/>
